...
String digitButtonText[] = {"7", "8", "9", "4", "5", "6", "1", "2", "3", "0", "+/-", ".","log","ln"};  
String operatorButtonText[] = {"/", "sqrt", "*", "%", "-", "1/X", "+", "=","TT","e","x^2","x^y","e^x" };  
String memoryButtonText[] = {"MC", "MR", "MS", "M+","sin","cos","tan" };  
...
displayLabel.setBounds(tempX,y,300,HEIGHT);  
...
operatorButton[i].setForeground(Color.RED);  //colorstext
...
{  
new MyCalculator("Calculator by Orawan");  
}  
}  
...
public void actionPerformed(ActionEvent ev)  
{  
String opText=((MyOperatorButton)ev.getSource()).getLabel();  //MyOperatorButton
